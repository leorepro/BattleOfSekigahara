...
SEKI.geography = {
  ...
  features: [
    ...
    /* ※ DEM 高程校正：以 SRTM 30m 真實高程取代固定 lat。奧馬哈海岸線在 DEM 中為斜向，
     *    各 WN 維持其對應灘段之 lng 與由西向東順序，沿內陸方向(降 lat)掃描，置於「最靠近
     *    灘頭、原始高程 ≥12m 的崖肩/崖頂」(可俯瞰灘頭、確屬陸地)。
     *    西端 WN72/71 已在 Pointe de la Percée 高地(46~48m)無需移；中東段 WN70/68/62/61
     *    原 lat(49.368x) 在 DEM 仍落 0~2.5m 海面/灘沙，下修至崖肩(高程見各列註記)。 */
    { name_zh:"WN72 據點", name_ja:"Widerstandsnest 72", name_en:"WN72", type:"bunker", lng:-0.9040, lat:49.3690, h:18,
      note:"扼守 D-1 Vierville 隘口西側，含 88mm 與 50mm 反戰車砲於混凝土砲廓內，沿灘側射，封鎖 Dog Green（DEM 46.5m 高地）" },
    { name_zh:"WN71 據點", name_ja:"Widerstandsnest 71", name_en:"WN71", type:"bunker", lng:-0.9010, lat:49.3688, h:20,
      note:"Vierville 隘口東側高地火力點，與 WN72 構成交叉火網（DEM 47.7m 高地）" },
    { name_zh:"WN70 據點", name_ja:"Widerstandsnest 70", name_en:"WN70", type:"bunker", lng:-0.8730, lat:49.3677, h:22,
      note:"Les Moulins 隘口上方崖頂火力點，俯瞰 Dog Red/Easy Green（DEM 校正 49.3685→49.3677，崖肩 14.5m）" },
    { name_zh:"WN68 據點", name_ja:"Widerstandsnest 68", name_en:"WN68", type:"bunker", lng:-0.8600, lat:49.3633, h:22,
      note:"St-Laurent E-1 隘口上方據點，封鎖 Easy Red 西側（DEM 校正 49.3683→49.3633，崖肩 12.8m）" },
    { name_zh:"WN62 據點", name_ja:"Widerstandsnest 62", name_en:"WN62", type:"bunker", lng:-0.8460, lat:49.3604, h:30,
      note:"奧馬哈最致命據點，Colleville 上方崖頂。兩座 75mm 砲與多挺 MG42，憑高俯瞰 Easy Red/Fox Green，造成最大量傷亡（DEM 校正 49.3680→49.3604，崖肩 14.2m）" },
    { name_zh:"WN61 據點", name_ja:"Widerstandsnest 61", name_en:"WN61", type:"bunker", lng:-0.8430, lat:49.3584, h:28,
      note:"WN62 東鄰，扼 E-3 Colleville 隘口東側，含 88mm 砲。被 DD 戰車與驅逐艦逐步壓制（DEM 校正 49.3682→49.3584，崖肩 13.3m）" },
    ...
    /* --- 濱海村鎮(town)：隘道頂端的目標村落 --------------------------- */
    /* ※ 村鎮在崖頂台地、較對應 WN 更內陸(更低 lat)；用 DEM 同法 snap 到高程 ≥25m 的台地。
     *    Vierville 原 lat 已在 26.6m 陸地無需移；Saint-Laurent/Colleville 原 lat 落 0m 海面，下修。 */
    { name_zh:"維耶維爾濱海鎮", name_ja:"Vierville-sur-Mer", name_en:"Vierville-sur-Mer", type:"town", lng:-0.9055, lat:49.3795, h:35,
      note:"D-1 隘道頂端村落，奧馬哈西端目標（DEM 26.6m 陸地）" },
    { name_zh:"聖洛朗濱海鎮", name_ja:"Saint-Laurent-sur-Mer", name_en:"Saint-Laurent-sur-Mer", type:"town", lng:-0.8650, lat:49.3632, h:38,
      note:"E-1 隘道頂端村落，灘頭中段目標，後為灘頭補給樞紐（DEM 校正 49.3810→49.3632，台地 25.8m）" },
    { name_zh:"科勒維爾濱海鎮", name_ja:"Colleville-sur-Mer", name_en:"Colleville-sur-Mer", type:"town", lng:-0.8470, lat:49.3598, h:42,
      note:"E-3 隘道頂端村落，WN62 後方。今美軍諾曼第公墓所在地（DEM 校正 49.3850→49.3598，台地 27.9m）" },
  ...
  lines: [
    {
      ...
      path:[
        ...
        [-0.8620,49.3680], /* E-1 St-Laurent 隘道仰攻(灘後崖坡) */
        [-0.8650,49.3632]  /* Saint-Laurent-sur-Mer(DEM 台地，隨村鎮內移) */
      ]
    },
    {
      ...
      path:[
        ...
        [-0.8460,49.3604], /* 仰攻 WN62(DEM 崖肩 14.2m) */
        [-0.8470,49.3598]  /* Colleville-sur-Mer(DEM 台地，隨村鎮內移) */
      ]
    },
    {

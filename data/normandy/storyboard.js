...
SEKI.storyboard = [
  ...
  { t:1.3, hold:14, cam:{lng:-0.9300, lat:49.3200, dist:175, az:0, el:16, orbit:0.22}, cam2:{dist:128, lat:49.3300}, slowmo:true, span:0.35,
  ...
  { t:2.4, hold:13, cam:{lng:-0.9450, lat:49.3250, dist:205, az:30, el:24, orbit:0.45},
  ...
  { t:3.5, hold:13, cam:{lng:-0.9150, lat:49.3300, dist:200, az:200, el:26, orbit:0.50},
  ...
  { t:6.7, hold:14, cam:{lng:-0.8950, lat:49.3720, dist:120, az:200, el:30, orbit:0.70}, cam2:{dist:94}, slowmo:true, span:0.35,
  ...
  { t:10, hold:13, cam:{lng:-1.0048, lat:49.3974, dist:130, az:0, el:26, orbit:0.60}, cam2:{dist:102, el:34}, slowmo:true, span:0.3,
  ...
  { t:44, hold:14, cam:{lng:-0.8650, lat:49.3850, dist:640, az:180, el:34, orbit:0.24}, cam2:{dist:740, az:150},
    ...
    commanders:[{zh:"第一軍",en:"US V Corps"}], focus:["us_2nd_div","beach_works","inf_16th"], side:"east" },
];

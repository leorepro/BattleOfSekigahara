...
SEKI.armies = [
  /* ============================ 西軍（紅） ============================ */
  { id:"ishida", name_zh:"石田三成", name_ja:"石田三成", side:'west', crest:'daiichi', kind:'artillery',
  ...
  { id:"ukita", name_zh:"宇喜多秀家", name_ja:"宇喜多秀家", side:'west', crest:'jiMonji', kind:'infantry',
  ...
  { id:"konishi", name_zh:"小西行長", name_ja:"小西行長", side:'west', crest:'gionmamori', kind:'matchlock',
  ...
  { id:"kikkawa", name_zh:"吉川廣家", name_ja:"吉川広家", side:'west', crest:'hikiryo', kind:'infantry',
  ...
  /* ============================ 東軍（藍） ============================ */
  { id:"tokugawa", name_zh:"德川家康", name_ja:"徳川家康", side:'east', crest:'mitsubaAoi', kind:'command',
  ...
  { id:"fukushima", name_zh:"福島正則", name_ja:"福島正則", side:'east', crest:'omodaka', kind:'infantry',
  ...
  { id:"ii", name_zh:"井伊直政", name_ja:"井伊直政", side:'east', crest:'tachibana', kind:'cavalry',
  ...
  { id:"kuroda", name_zh:"黒田長政", name_ja:"黒田長政", side:'east', crest:'fujiTomoe', kind:'matchlock',
  ...
  { id:"hosokawa", name_zh:"細川忠興", name_ja:"細川忠興", side:'east', crest:'kuyo', kind:'infantry',
  ...
  { id:"todo", name_zh:"藤堂高虎", name_ja:"藤堂高虎", side:'east', crest:'tsuta', kind:'infantry',
  ...
  { id:"kyogoku", name_zh:"京極高知", name_ja:"京極高知", side:'east', crest:'yotsumeyui', kind:'infantry',
  ...
  { id:"kato", name_zh:"加藤嘉明", name_ja:"加藤嘉明", side:'east', crest:'janome', kind:'matchlock',
  ...
  { id:"tanaka", name_zh:"田中吉政", name_ja:"田中吉政", side:'east', crest:'mitsudomoe', kind:'infantry',

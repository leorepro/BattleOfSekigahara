...
SEKI.armies = [
  /* ============================ 西軍（紅） ============================ */
  { name_zh:"石田三成", name_ja:"石田三成", side:'west', crest:'daiichi',
  ...
  { name_zh:"宇喜多秀家", name_ja:"宇喜多秀家", side:'west', crest:'jiMonji',
  ...
  { name_zh:"大谷吉繼", name_ja:"大谷吉継", side:'west', crest:'mukaiCho',
  ...
  { name_zh:"小早川秀秋", name_ja:"小早川秀秋", side:'west', crest:'chigaiKama',
  ...
  { name_zh:"毛利秀元", name_ja:"毛利秀元", side:'west', crest:'ichimonjiMitsuboshi',
  ...
  { name_zh:"島津義弘", name_ja:"島津義弘", side:'west', crest:'maruJuji',
  ...
  /* ============================ 東軍（藍） ============================ */
  { name_zh:"德川家康", name_ja:"徳川家康", side:'east', crest:'mitsubaAoi',
  ...
  { name_zh:"福島正則", name_ja:"福島正則", side:'east', crest:'omodaka',
  ...
  { name_zh:"井伊直政", name_ja:"井伊直政", side:'east', crest:'tachibana',
  ...
  { name_zh:"本多忠勝", name_ja:"本多忠勝", side:'east', crest:'tachiAoi',
  ...
  { name_zh:"黒田長政", name_ja:"黒田長政", side:'east', crest:'fujiTomoe',

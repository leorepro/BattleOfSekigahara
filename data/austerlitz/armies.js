...
SEKI.armies = [
  ...
  { id:"const_guard", name_zh:"俄國近衛軍", name_ja:"Russian Guard · Grand Duke Constantine", side:'west', faction:'russian_guard', factionColor:0x2c5436, kind:'command',
    ...
    track:[
      ...
      { t:6,  lng:16.792,lat:49.128,s:10430, st:'hold' },  // 正午前仍在高地東北作預備(逐字稿:近衛軍對決在正午後)
      { t:7,  lng:16.772,lat:49.124,s:9000,  st:'charge' },// ★12:40 近衛騎兵反撲普拉欽·騎砲轟破方陣
      { t:7.8,lng:16.792,lat:49.128,s:5500,  st:'rout' },  // 被拉普近衛騎兵反擊擊退(莫蘭德陣亡·俘列普寧)
